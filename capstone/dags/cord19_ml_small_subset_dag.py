...
#     )
    ...
    start >> load_preprocessed_data_from_s3_and_save_it_locally >> verify_data >> collect_small_subset >> vectorization_compute_sparse_matrix
    vectorization_compute_sparse_matrix >> vectorization_reduce_dimensionality_with_PCA >> end
